...
import {createMatch, MatchData} from '../src'

function absoluteFameUnchanged(before: MatchData, after: MatchData) {
  let fameBefore = 0
  let fameAfter = 0
...
describe('Match', () => {
  ...
  describe('#rate() simpleCase', () => {
    it('works', () => {
      const match = createMatch(simpleCase)
  ...
  describe('#rate() simpleCase keep incoming keys', () => {
    ...
    it('works', () => {
      const match = createMatch(simpleCaseKeepKeys)
  ...
  describe('#rate() bizarreCase keep incoming keys', () => {
    ...
    it('works', () => {
      const match = createMatch(bizarreCaseKeepKeys)
  ...
  describe('#rate() oneWinnerMaxesOut', () => {
    it('works', () => {
      const match = createMatch(oneWinnerMaxesOut)
      const expected = {
        teams: [
          [
            {id: 1, fame: 100},
      ...
      const result = match.rate()
      assert.strictEqual(absoluteFameUnchanged(oneWinnerMaxesOut, result), true)
      assert.deepEqual(result, expected)
    })
  })
  ...
  describe('#rate() bothWinnersMaxOut', () => {
    it('works', () => {
      const match = createMatch(bothWinnersMaxOut)
      const expected = {
        teams: [
          [
            {id: 1, fame: 100},
      ...
      const result = match.rate()
      assert.strictEqual(absoluteFameUnchanged(bothWinnersMaxOut, result), true)
      assert.deepEqual(result, expected)
    })
  })
  ...
  describe('#rate() oneVsTwo', () => {
    it('works', () => {
      const match = createMatch(oneVsTwo)
      const expected = {
        teams: [
          [{id: 1, fame: 73}],
          [
  ...
  describe('#rate() twoVsOne', () => {
    it('works', () => {
      const match = createMatch(twoVsOne)
      const expected = {
        teams: [
          [
            {id: 1, fame: 63},
  ...
  describe('#rate() oneVsOneOverflow', () => {
    it('works', () => {
      const match = createMatch(oneVsOneOverflow)
      const expected = {
        teams: [[{id: 1, fame: 100}], [{id: 2, fame: 49}]],
      }
      const result = match.rate()
  ...
  describe('#rate() unbalancedOne', () => {
    it('works', () => {
      const match = createMatch(unbalancedOne)
      const expected = {
        teams: [
          [
            {id: 1, fame: 99},
  ...
  describe('#rate() unbalancedTwo', () => {
    it('works', () => {
      const match = createMatch(unbalancedTwo)
      const expected = {
        teams: [
          [
            {id: 1, fame: 100},
  ...
  describe('#rate() betPreservation', () => {
    it('works', () => {
      const match = createMatch(betPreservation)
      const expected = {
        teams: [
          [
            {id: 1, fame: 100},
